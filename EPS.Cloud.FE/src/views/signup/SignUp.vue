  ...
  <div class="signup">
    ...
    <div class="signup__container">
      ...
      <minput
        ...
        rules="required|minlength_8|containsUppercase|includeNumber|containsSpecialCharacter"
        formName="User"
        class="mb-2"
        :icon1="icon1"
        :icon2="icon2"
      ...
      <div class="rules">
        ...
        <div class="flex-start">
          <Done
            class="done"
            v-show="!showWarning.includes('containsUppercase')"
          />
        ...
        <div class="flex-start">
          <Done
            class="done"
            v-show="!showWarning.includes('containsSpecialCharacter')"
          />
